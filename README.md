...
## Project
Hi, devs. I am going to explain pexels API to you. I will use fetch API to fetch data from API.

## Features
- Search photos via query.
- Pagination.
- Attractive UI.
...
## Project Live
### [Click here](https://pexels0799.netlify.app/) 
...
[Click here](https://github.com/ShravanMeena/API-Pexels-gallery) to Contribute 
